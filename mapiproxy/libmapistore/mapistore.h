...
struct mapistore_backend {
	...
	struct {
		...
		enum mapistore_error	(*delete_message)(void *, uint64_t, uint8_t);
                enum mapistore_error	(*move_copy_messages)(TALLOC_CTX *, void *, void *, uint32_t, uint64_t *, uint64_t *, struct Binary_r **, uint8_t);
...
enum mapistore_error mapistore_folder_move_copy_messages(struct mapistore_context *, TALLOC_CTX *, uint32_t, void *, void *, uint32_t, uint64_t *, uint64_t *, struct Binary_r **, uint8_t);
