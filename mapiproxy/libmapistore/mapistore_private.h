...
enum mapistore_error mapistore_backend_folder_move_copy_messages(struct backend_context *, TALLOC_CTX *, void *, void *, uint32_t, uint64_t *, uint64_t *, struct Binary_r **, uint8_t);
